...
!
    ...
    !
    write(*,*) "ENTER calc_gasopd H2ON28"
    ...
    do ik = 1,pverp 
      ...
      t_ref_index_s = ks_ntemp  ! not needed for bps
      ...
      if (bps_continuum) then   !! Do BPS H2O Continuum
        ...
        do iw = iwbeg,iwend     ! loop over bands      
          do ig=1, ngauss_pts(iw)
            ...
            radfield = (exp(2*arg2)-1)/(exp(2*arg2)+1) &
                     / (exp(2*arg1)-1)/(exp(2*arg1)+1)
