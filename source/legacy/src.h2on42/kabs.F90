...
!  version n42_h2o
  ...
  character(len=256), parameter :: dirk = '/projects/wolfet/models/ExoRT/absorption_data/h2on42/hitran2012/'
  ...
  character(len=256), parameter :: dirct = '/projects/wolfet/models/ExoRT/absorption_data/continuum/'
  !mtckd
