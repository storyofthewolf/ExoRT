...
!============================================================================
  ...
  subroutine calc_gasopd(tmid, pmid, pdel, coldens, coldens_dry, qh2o, qco2, qch4, qO2, qO3, qH2, qN2, pathlength, &
                         tau_gas, tau_ray, tau_n2n2cia, tau_h2n2cia, tau_h2h2cia)
...
!
    ...
    real(r8), intent(out), dimension(ntot_wavlnrng,pverp) ::  tau_n2n2cia
    real(r8), intent(out), dimension(ntot_wavlnrng,pverp) ::  tau_h2n2cia
    real(r8), intent(out), dimension(ntot_wavlnrng,pverp) ::  tau_h2h2cia
...
!      endif
      ...
      do ig = 1,ngauss_pts(1)      
        itl = itl + 1         
        call bilinear_interpK_8gpt(k01_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
