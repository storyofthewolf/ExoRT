...
! here I know u_h2o, u_co2 and u_ch4, but I don't know which ones are major or minor species
! i need a map (nspec, ngas)

      !=====  interval 1:  =====!
      u_major =       
      do ig = 1,ngauss_pts(1)      
        itl = itl + 1         
        call bilinear_interpK_8gpt(k01_major_data(gas_order(sp1,1),:,:,:), ig, pressure, p_ref_index, temperature, t_ref_index, kmajor) 
        !minor gases
        call bilinear_interpK(k_grey_data(gas_order(sp1,2),:,:,:), ig, pressure, p_ref_index, temperature, t_ref_index, kgrey1) 
        call bilinear_interpK(k_grey_data(gas_order(sp1,3),:,:,:), ig, pressure, p_ref_index, temperature, t_ref_index, kgrey2) 
        umajor = ugas(gas_order(sp1,1))
        ugrey1 = ugas(gas_order(sp1,2))
        tau_gas(itl,ik) = kmajor*umajor * kgrey*u_grey1 + kgrey2*ugrey2          
      enddo   
      ...
      do ig = 1,ngauss_pts(2)    
        itl = itl + 1
        call bilinear_interpK_8gpt(k02_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
      ...
      do ig = 1,ngauss_pts(3)   
        itl = itl + 1
        call bilinear_interpK_8gpt(k03_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(4)          
        itl = itl + 1
        call bilinear_interpK_8gpt(k04_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col
      enddo   
      ...
      do ig = 1,ngauss_pts(5)   
        itl = itl + 1
        call bilinear_interpK_8gpt(k05_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(6)    
        itl = itl + 1
        call bilinear_interpK_8gpt(k06_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(7)		  
        itl = itl + 1
        call bilinear_interpK_8gpt(k07_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(8)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k08_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(9)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k09_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(10)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k10_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(11)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k11_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(12)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k12_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(13)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k13_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(14)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k14_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(15)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k15_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(16)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k16_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(17)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k17_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(18)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k18_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(19)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k19_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(20)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k20_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(21)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k21_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(22)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k22_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(23)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k23_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(24)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k24_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(25)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k25_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(26)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k26_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(27)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k27_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(28)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k28_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(29)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k29_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(30)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k30_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(31)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k31_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(32)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k32_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(33)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k33_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(34)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k34_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(35)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k35_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(36)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k36_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(37)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k37_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(38)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k38_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(39)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k39_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(40)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k40_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(41)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k41_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
      ...
      do ig = 1,ngauss_pts(42)             
        itl = itl + 1
        call bilinear_interpK_8gpt(k42_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
        tau_gas(itl,ik) = ans*u_col          
      enddo   
       ...
       do ig = 1,ngauss_pts(43)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k43_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(44)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k44_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(45)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k45_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(46)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k46_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(47)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k47_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(48)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k48_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(49)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k49_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(50)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k50_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(51)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k51_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(52)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k52_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(53)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k53_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(54)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k54_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(55)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k55_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(56)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k56_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(57)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k57_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(58)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k58_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(59)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k59_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(60)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k60_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(61)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k61_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(62)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k62_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(63)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k63_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(64)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k64_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(65)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k65_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(66)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k66_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(67)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k67_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
       ...
       do ig = 1,ngauss_pts(68)             
         itl = itl + 1
         call bilinear_interpK_8gpt(k68_data, ig, pressure, p_ref_index, temperature, t_ref_index, ans)
         tau_gas(itl,ik) = ans*u_col          
       enddo   
