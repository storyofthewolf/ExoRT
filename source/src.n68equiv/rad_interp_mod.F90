...
!
  ...
  public :: interpO2O2cia
  public :: interpO2N2cia
  public :: interpO2CO2cia
...
!============================================================================
  ...
  subroutine interpO2O2cia(Kdata, temperature, t_ref_index, ans )


!------------------------------------------------------------------------
!
! Purpose: Interpolate O2-O2 collision induced absorption coefficients
!
!------------------------------------------------------------------------
...
! Arguments
!
    real(r8), intent(in) :: Kdata(ntot_wavlnrng,ko2o2_ntemp)
    real(r8), intent(in) :: temperature
    integer, intent(inout) :: t_ref_index
    real(r8), intent(out) :: ans(ntot_wavlnrng)
...
!
    ...
    if (t_ref_index .eq. ko2o2_ntemp) then
      t_ref_index = t_ref_index - 1
      t_ref_indexp1 = t_ref_index + 1
      temp = (temperature - tgrid_o2o2(t_ref_index))/(tgrid_o2o2(t_ref_indexp1) - tgrid_o2o2(t_ref_index))
    else
      temp = (temperature - tgrid_o2o2(t_ref_index))/(tgrid_o2o2(t_ref_indexp1) - tgrid_o2o2(t_ref_index))
    endif
  ...
  end subroutine interpO2O2cia


!============================================================================

  subroutine interpO2N2cia(Kdata, temperature, t_ref_index, ans )


!------------------------------------------------------------------------
!
! Purpose: Interpolate O2-N2 collision induced absorption coefficients
!
!------------------------------------------------------------------------
...
! Arguments
!
    real(r8), intent(in) :: Kdata(ntot_wavlnrng,ko2n2_ntemp)
    real(r8), intent(in) :: temperature
    integer, intent(inout) :: t_ref_index
    real(r8), intent(out) :: ans(ntot_wavlnrng)
...
!
    ...
    if (t_ref_index .eq. ko2n2_ntemp) then
      t_ref_index = t_ref_index - 1
      t_ref_indexp1 = t_ref_index + 1
      temp = (temperature - tgrid_o2n2(t_ref_index))/(tgrid_o2n2(t_ref_indexp1) - tgrid_o2n2(t_ref_index))
    else
      temp = (temperature - tgrid_o2n2(t_ref_index))/(tgrid_o2n2(t_ref_indexp1) - tgrid_o2n2(t_ref_index))
    endif
  ...
  end subroutine interpO2N2cia


!============================================================================

  subroutine interpO2CO2cia(Kdata, temperature, t_ref_index, ans )


!------------------------------------------------------------------------
!
! Purpose: Interpolate O2-CO2 collision induced absorption coefficients
!
!------------------------------------------------------------------------
...
! Arguments
!
    real(r8), intent(in) :: Kdata(ntot_wavlnrng,ko2co2_ntemp)
    real(r8), intent(in) :: temperature
    integer, intent(inout) :: t_ref_index
    real(r8), intent(out) :: ans(ntot_wavlnrng)
