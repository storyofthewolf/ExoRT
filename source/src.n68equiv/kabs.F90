...
!  version eqv, read in single gas k-coefficients from files
  ...
  character(len=256), parameter :: kn2h2cia_file = 'N2-H2_cia_n68.nc'
  character(len=256), parameter :: kh2h2cia_file = 'H2-H2_cia_n68.nc'
  character(len=256), parameter :: kco2co2cia_sw_file = 'CO2-CO2_cia_sw_n68.nc'
