...
!  version eqv, read in single gas k-coefficients from files
  ...
  ! NH3/CO k-tables fit on the n84 band grid (generated offline). Same dirs as
  ! n68 (the n68* dir names are legacy labels, not band counts).
  character(len=256), parameter :: k_nh3_file  = 'n84_8gpt_nh3_n84_gpt8_nh3_hitran2024_Nnu1e4_c25_subL_q0_grrtm.nc'
  character(len=256), parameter :: k_co_file   = 'n84_8gpt_co_n84_gpt8_co_hitran2024_Nnu1e4_c25_subL_q0_grrtm.nc'
