...
!u_co2=u_co2*1.57
      ...
      itl = 0
      !=====  interval 1:   =====!
      !=====  0 - 40 cm-1  ::  infinity - 250 microns
      sp=1
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 4:   =====!
      !=====  160 - 220 cm-1  ::  62.5 - 45.4545  microns
      sp=4
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 5:   =====!
      !=====  220 - 280 cm-1  :: 45.4545 - 35.7143 microns
      sp=5
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 6:   =====!
      !=====  280 - 330 cm-1  ::  35.7143 - 30.3030 microns
      sp=6
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 7:   =====!
      !=====  330 - 380 cm-1  ::  30.3030 - 26.3158 microns
      sp=7
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 8:   =====!
      !=====  380 - 440 cm-1   ::  26.3158 - 22.7273 microns
      sp=8
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 9:   =====!
      !=====  440 - 495 cm-1  :: 22.7273 - 20.2020 microns
      sp=9
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 10:  =====!
      !=====  495 - 545 cm-1  ::  20.2020 - 18.3486 microns
      sp=10
...
!write(*,*) "interval 10, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 11:  =====!
      !=====  545 - 617 cm-1  ::  18.3486 - 16.2075 microns
      sp=11
...
!write(*,*) "interval 11, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 12:  =====
      !=====  617 - 667 cm-1  ::  16.2075 - 14.9925 microns
      sp=12
...
!write(*,*) "interval 12, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 13:  =====!
      !=====  667 - 720 cm-1  ::  14.9925 - 13.8889 microns
      sp=13
...
!write(*,*) "interval 13, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 14:  =====!
      !=====  720 - 800 cm-1  ::  13.8889 - 12.5 micons
      sp=14
...
!write(*,*) "interval 14, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 15:  =====!
      !=====  800 - 875 cm-1  ::  12.5 - 11.4286 microns
      sp=15
...
!write(*,*) "interval 15, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 16:  =====!
      !=====  875 - 940 cm-1  ::  11.4286 - 10.6383 microns
      sp=16
...
!write(*,*) "interval 16, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 17:  =====!
      !=====  940 - 1000 cm-1  ::  10.6383 - 10.0 microns
      sp=17
...
!write(*,*) "interval 17, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 18:  =====!
      !=====  1000 - 1065 cm-1  ::  10.0 - 9.38967 microns
      sp=18
...
!write(*,*) "interval 18, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 19:  =====!
      !=====  1065 - 1108 cm-1  ::  9.38967 - 9.02527 microns
      sp=19
...
!write(*,*) "interval 19, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 20:  =====!
      !=====  1108 - 1200 cm-1  ::  9.02527 - 8.33333 microns
      sp=20
...
!write(*,*) "interval 20, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 21:  =====!
      !=====  1200 - 1275 cm-1  ::  8.33333 - 7.84314 microns
      sp=21
...
!write(*,*) "interval 21, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 22:  =====!
      !=====  1275 - 1350 cm-1  ::  7.84314 - 7.40741 microns
      sp=22
...
!write(*,*) "interval 22, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 23:  =====!
      !=====  1350 - 1450 cm-1  ::  7.40741 - 6.89655 microns
      sp=23
...
!write(*,*) "interval 23, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 24:  =====!
      !=====  1450 - 1550 cm-1  ::  6.89655 - 6.45161 microns
      sp=24
...
!write(*,*) "interval 24, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 25:  =====!
      !=====  1550 - 1650 cm-1  ::  6.45161 - 6.06061 microns
      sp=25
...
!write(*,*) "interval 25, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 26:  =====!
      !=====  1650 - 1750 cm-1  ::  6.06061 - 5.71429 microns
      sp=26
...
!write(*,*) "interval 26, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 27:  =====!
      !=====  1750 - 1850 cm-1  ::  5.71429 - 5.40541 microns
      sp=27
...
!write(*,*) "interval 27, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 28:  =====!
      !=====  1850 - 1950 cm-1  ::   5.40541 - 5.12821 microns
      sp=28
...
!write(*,*) "interval 28, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 29:  =====!
      !=====  1950 - 2050 cm-1  ::  5.12821 - 4.87805 microns
      sp=29
...
!write(*,*) "interval 29, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 30:  =====!
      !=====  2050 - 2200 cm-1  ::  4.87805 - 4.54545 microns
      sp=30
...
!write(*,*) "interval 30, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 31:  =====!
      !=====  2200 - 2397 cm-1  ::  4.54545 - 4.17188 microns
      sp=31
...
!write(*,*) "interval 31, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 32:  =====
      !=====  2397 - 2494 cm-1  :: 4.17188 - 4.00962 microns
      sp=32
...
!write(*,*) "interval 32, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 33:  =====!
      !=====  2494 - 2796 cm-1  ::  4.00962 - 3.57654 microns
      sp=33
...
!write(*,*) "interval 33, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 34:  =====!
      !=====  2796 - 3087 cm-1  ::  3.57654 - 3.23939 microns
      sp=34
...
!write(*,*) "interval 34, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 35:  =====!
      !=====  3087 - 3425 cm-1  ::  3.23939 - 2.91971 microns
      sp=35
...
!write(*,*) "interval 35, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 36:  =====!
      !=====  3425 - 3760 cm-1  ::  2.91971 - 2.65957 microns
      sp=36
...
!write(*,*) "interval 36, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 37:  =====!
      !=====  3760 - 4030 cm-1  ::  2.65957 - 2.48139 microns
      sp=37
...
!write(*,*) "interval 37, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 38:  =====!
      !=====  4030 - 4540 cm-1  ::  2.48139 - 2.20264 microns
      sp=38
...
!write(*,*) "interval 38, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 39:  =====!
      !=====  4540 - 4950 cm-1  ::  2.20264 - 2.02020 microns
      sp=39
...
!write(*,*) "interval 39, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 40:  =====!
      !=====  4950 - 5370 cm-1  ::  2.02020 - 1.86220 microns
      sp=40
...
!write(*,*) "interval 40, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 41:  =====!
      !=====  5370 - 5925 cm-1  ::  1.86220 - 1.68776 microns
      sp=41
...
!write(*,*) "interval 41, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 42:  =====!
      !=====  5925 - 6390 cm-1  ::  1.68776 - 1.56495 microns
      sp=42
...
!write(*,*) "interval 42, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 43:  =====!
      !=====  6390 - 6990 cm-1  ::  1.56495 - 1.43062 microns
      sp=43
...
!write(*,*) "interval 43, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 44:  =====!
      !=====  6990 - 7650 cm-1  ::  1.43062 - 1.30719 microns
      sp=44
      ...
      tau_grey(iCH4) = ans_kgrey_ch4 * ugas(iCH4)
      imajor = maxloc(tau_grey)
!write(*,*) "interval 44, major: ", imajor
!write(*,*) ik, sp, gas_name(imajor), tau_grey, ans_kgrey_h2o, ans_kgrey_co2, ans_kgrey_ch4
      ! major gas (k-distribution)
...
!!write(*,*) "kmajor", ans_kmajor_gptvec
      ...
      !=====  interval 45:  =====!
      !=====  7650 - 8315 cm-1  :: 1.30719 - 1.20265 microns
      sp=45
...
!write(*,*) "interval 45, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 46:  =====!
      !=====  8315 - 8850 cm-1  ::  1.20265 - 1.12994 microns
      sp=46
...
!write(*,*) "interval 46, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 47:  =====!
      !=====  8850 - 9350 cm-1  ::  1.12994 - 1.06952 microns
      sp=47
...
!write(*,*) "interval 47, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 48:  =====!
      !=====  9350 - 9650 cm-1  ::  1.06952 - 1.03627 microns
      sp=48
...
!write(*,*) "interval 48, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 49:  =====!
      !=====  9650 - 10400 cm-1  ::  1.03627 - 0.961538 microns
      sp=49
...
!write(*,*) "interval 49, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 50:  =====!
      !==== 10400 - 11220 cm-1  ::  0.961538 - 0.891266 microns
      sp=50
...
!write(*,*) "interval 50, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 51:  =====!
      !=====  11220 - 11870 cm-1  ::  0.891266 - 0.842460 microns
      sp=51
...
!write(*,*) "interval 51, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 52:  =====!
      !=====  11870 - 12790 cm-1  ::  0.842460 - 0.781861 microns
      sp=52
...
!write(*,*) "interval 52, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 53:  =====!
      !=====  12790 - 13300 cm-1  ::  0.781861 - 0.751880 microns
      sp=53
...
!write(*,*) "interval 53, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 54:  =====!
      !=====  13300 - 14470 cm-1  ::  0.751880 - 0.691085 microns
      sp=54
...
!write(*,*) "interval 54, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 55:  =====!
      !=====  14470 - 15000 cm-1  ::  0.691085 - 0.666667 microns
      sp=55
...
!write(*,*) "interval 55, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 56:  =====!
      !=====  15000 - 16000 cm-1  ::  0.666667 - 0.625000 microns
      sp=56
...
!write(*,*) "interval 56, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 57:  =====!
      !=====  16000 - 16528 cm-1  ::  0.625000 - 0.605034 microns
      sp=57
...
!write(*,*) "interval 57, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 58:  =====!
      !=====  16528 - 17649 cm-1  ::  0.605034 - 0.566604 microns
      sp=58
...
!write(*,*) "interval 58, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 59:  =====!
      !=====  17649 - 18198 cm-1  ::  0.566604 - 0.549511 microns
      sp=59
...
!write(*,*) "interval 59, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 60:  =====!
      !=====  18198 - 18518 cm-1  ::  0.549511 - 0.540015 microns
      sp=60
...
!write(*,*) "interval 60, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 61:  =====!
      !=====  18518 - 22222 cm-1  ::  0.540015 - 0.450004 microns
      sp=61
...
!write(*,*) "interval 61, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 62:  =====!
      !=====  22222 - 25641 cm-1  ::  0.450004 - 0.39 microns
      sp=62
...
!write(*,*) "interval 62, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 63:  =====!
      !=====  25641 - 29308 cm-1  ::  0.39 - 0.341204 microns
      sp=63
...
!write(*,*) "interval 63, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 64:  =====!
      !=====  29308 - 30376 cm-1  ::  0.341204 - 0.329207 microns
      sp=64
...
!write(*,*) "interval 64, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 65:  =====!
      !=====  30376 - 32562 cm-1  ::  0.329207 - 0.307106 microns
      sp=65
...
!write(*,*) "interval 65, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 66:  =====!
      !=====  32562 - 35087 cm-1  ::  0.307106 - 0.285006 microns
      sp=66
...
!write(*,*) "interval 66, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 67:  =====!
      !=====  35087 - 36363 cm-1  ::  0.285006 - 0.275005 microns
      sp=67
...
!write(*,*) "interval 67, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
      do ig = 1,ngauss_pts(sp)      
        itl = itl + 1         
        tau_gas(itl,ik) = ans_kmajor_gptvec(ig)*ugas(imajor(1)) + (tau_grey(iH2O) + tau_grey(iCO2) + tau_grey(iCH4) - tau_grey(imajor(1)))
      ...
      !=====  interval 68:  =====!
      !=====  36363 - 42087 cm-1  ::  0.275005 - 0.237603 microns
      sp=68
...
!write(*,*) ik, sp, gas_name(imajor), tau_grey, ans_kgrey_h2o, ans_kgrey_co2, ans_kgrey_ch4
      ! major gas (k-distribution)
!write(*,*) "interval 68, major: ", imajor
!!write(*,*) "kmajor", ans_kmajor_gptvec
...
!      write(*,*) "ik, iw, ,r, q, w, f, co2, tau: ", ik, iw, r_ice, Qice, Wice, Gice, ext_cICE_co2(ik), tau_cld_co2(iw,ik), singscat_cld_co2(iw,ik), asym_cld_co2(iw,ik)
    enddo
!   write(*,*) "tau_cld_co2", ik, tau_cld_co2(55,ik)
  enddo
!   write(*,*) "+++++++++++++++++++++++++++++++++++++++++++++++"
!   write(*,*) "sum(tau_cld_co2)", SUM(tau_cld_co2(55,:))
