...
!      write(*,*) "rei_co2_idx", do_exo_condense_co2
!      write(*,*) "rei_co2_idx", rei_co2_idx
    endif
...
!write(*,*) "exo_radiation_tend, co2 cloud, rei", rei_co2 
!write(*,*) "exo_radiation_tend, co2 cloud, cice", cicewp_co2 
