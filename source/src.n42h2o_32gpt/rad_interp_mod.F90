...
!============================================================================
  ...
  subroutine bilinear_interpK_32gpt(Kdata, ig, pressure, p_ref_index, temperature, t_ref_index, ans) 
...
! Input Arguments
!
    real(r8), intent(in) ::Kdata(32, kc_npress, kc_ntemp)
...
!    write(*,*) "------------------------------------------------------" 
  ...
  end subroutine bilinear_interpK_32gpt
