...
! Purpose:                                                                   
  ...
  integer, parameter  :: sw_iwbeg = 22    ! solar band wvl integration limits                    
  integer, parameter  :: sw_iwend = 71
  integer, parameter  :: lw_ipbeg = 1     ! thermal band gpt integration limits                  
  integer, parameter  :: lw_ipend = 296
  integer, parameter  :: sw_ipbeg = 169   ! solar band gpt integration limits                    
  integer, parameter  :: sw_ipend = 568
