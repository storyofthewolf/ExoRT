...
liq_filename = 'cloudoptics_liquid_mie.nc'
ice_filename = 'cloudoptics_ice_mie.nc'

;-------- input file list ----------
LIQUID_MIE_FILE = '/projects/wolfet/models/ExoRT/data/cloud/refractive_indices/Segelstein_liquid.txt'
ICE_MIE_FILE    = '/projects/wolfet/models/ExoRT/data/cloud/refractive_indices/Warren_ice.txt'
