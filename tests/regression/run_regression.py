...
exort.exe on the HITRAN-2016 native-gas line list (see EXORT_H16_N68vN84_GRID.md
...
def build_cases():
    ...
    # Earth-like TS300K column with an upper-atmosphere haze slab, exercising
    # the Stage C3 CARMA aerosol path (do_exo_haze set at runtime). Two
    # loadings bracket the regime: optically thin (visible tau ~0.5, where the
    # haze perturbs the column) and thick (tau ~8.6, where it dominates the
    # shortwave). Both decks are generated by fixtures/make_haze_fixture.py,
    # which solves for the target tau against data/aerosol/haze_n84_b40_mie.nc
    # -- rerun it and rebaseline if the haze optics change.
    cases.append({
    ...
    cases.append({
        "name": "TS300K_hazethick_G2V",
        "fixture": "RTprofile_in_TS300K_hazethick.nc",
        "star": "G2V_SUN_n68.nc",
        "scon": 680.0,
        "g": 9.80616,
        "haze": True,
